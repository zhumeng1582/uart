...
public class AccessParaContent {
    public static AccessPara accessPara1 = new AccessPara("通道1","/dev/ttyS1","/sys/class/leds/relay1/brightness");
    public static AccessPara accessPara2 = new AccessPara("通道2","/dev/ttyS2","/sys/class/leds/relay1/brightness");
